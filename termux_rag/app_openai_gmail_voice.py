...
<body>
    <div class="app">
        ...
        <div class="input-container" id="inputContainer">
            <div class="quick-actions">
                ...
                <button class="quick-btn" onclick="quickHelp()">❓ 도움말</button>
            </div>
    ...
    <script>
        ...
        function addMsg(text, isUser, sources = [], mailInfo = null) {
        ...
        function quickHelp() {
            document.getElementById('userInput').value = '사용법 알려줘';
            sendMessage();
        }
        ...
        async function sendMessage() {
            ...
            try {
                ...
                addMsg(data.answer, false, data.sources, mailInfo);
                speak(data.answer);
                checkHealth();
            } catch(e) {
                hideTyping();
