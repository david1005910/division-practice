...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .voice-btn { width: 50px; height: 50px; border-radius: 50%; border: none; background: linear-gradient(135deg, #10a37f, #1a7f5a); color: white; font-size: 1.3rem; cursor: pointer; flex-shrink: 0; }
        ...
        .send-btn { width: 100%; padding: 14px; background: linear-gradient(135deg, #10a37f, #1a7f5a); border: none; border-radius: 25px; color: white; font-weight: bold; font-size: 1rem; cursor: pointer; }
    ...
    <script>
        ...
        async function checkHealth() {
            try {
                ...
                document.getElementById('statusText').textContent = 'GPT 연결됨';
