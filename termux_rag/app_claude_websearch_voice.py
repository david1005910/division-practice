#!/usr/bin/env python3
"""
Voice RAG + Claude + 웹검색 통합 시스템 (All-in-One)
...
사용법:
    python app_claude_websearch_voice.py
...
<head>
    ...
    <title>🎤 Voice RAG + Claude + 웹검색</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .message-actions button { background: rgba(102,126,234,0.2); border: 1px solid #667eea; color: #667eea; padding: 4px 10px; border-radius: 12px; font-size: 0.7rem; cursor: pointer; }
        .message-actions button:hover { background: rgba(102,126,234,0.4); }
        ...
        /* 음성 버튼 */
        .voice-btn { width: 50px; height: 50px; border-radius: 50%; border: none; background: linear-gradient(135deg, #667eea, #764ba2); color: white; font-size: 1.3rem; cursor: pointer; flex-shrink: 0; transition: transform 0.1s; }
        ...
        /* 전송 버튼 */
        .send-btn { padding: 12px 20px; background: linear-gradient(135deg, #667eea, #764ba2); border: none; border-radius: 25px; color: white; font-weight: bold; font-size: 0.9rem; cursor: pointer; }
        ...
        /* 문서 아이템 */
        .doc-item { background: #1a1a2e; padding: 12px; border-radius: 10px; margin-bottom: 10px; border-left: 3px solid #667eea; }
        .doc-item-id { color: #667eea; font-size: 0.8rem; font-weight: bold; }
        ...
        /* 모델 정보 */
        .model-info { background: #1a1a2e; padding: 15px; border-radius: 10px; margin-bottom: 10px; border-left: 3px solid #667eea; }
        .model-info h3 { color: #667eea; font-size: 0.9rem; margin-bottom: 8px; }
        ...
        .badge-rag { background: rgba(102,126,234,0.2); color: #667eea; border: 1px solid #667eea; }
    ...
    <div class="app">
        ...
        <div class="chat-container" id="chatContainer">
            <div class="message bot">
                안녕하세요! 저는 Claude 기반 AI 어시스턴트예요. 🤖<br><br>
                🎤 <b>음성 버튼</b>을 눌러 말하거나 텍스트로 입력하세요<br>
                📚 <b>RAG</b>: 저장된 문서에서 검색<br>
                🌐 <b>웹검색</b>: 최신 정보를 인터넷에서 검색<br><br>
                무엇이든 물어보세요!
            </div>
        </div>
        ...
        <div class="tab-content" id="settingsTab">
            <div class="model-info">
                ...
                <p>Anthropic의 Claude AI + 웹검색 도구를 사용합니다.</p>
            </div>
...
if __name__ == '__main__':
    ...
    print("   🌐 웹검색: 인터넷에서 최신 정보 검색 (2024년 이후 가능!)")
    
    if ANTHROPIC_API_KEY:
        print("\n✅ Anthropic API 키 설정됨")
    else:
        print("\n⚠️  Anthropic API 키가 없습니다!")
